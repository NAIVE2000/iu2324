      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <li class="nav-item">
          ...
          <div class="nav-item ms-auto">
            <div class="btn-group">
              <button id="save" class="btn btn-outline-secondary" title="save">💾</button>
              <button id="clean" class="btn btn-outline-secondary" title="clean">🧽</button>
              <button id="restore" class="btn btn-outline-secondary" title="restore">↩️</button>
            </div>
          </div>
      </div>
    </div>
